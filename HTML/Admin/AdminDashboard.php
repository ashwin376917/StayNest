...
// Count banned users (guest + host with banned = 1)
...
// Recent host property additions
...
// Merge results for recent activities
$activities = [];
...
<body class="bg-gray-50 font-sans p-6">
  ...
  <nav class="text-sm text-gray-500 mb-2">
    <span>Dashboard</span> &gt; <span class="text-gray-800 font-medium">Manage Users</span>
  </nav>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
    <div class="bg-white shadow-sm rounded-2xl p-6 border border-gray-200 hover:shadow-lg transition">
      ...
      <div class="text-4xl font-bold text-blue-600"><?php echo $totalGuests; ?></div>
    ...
    <div class="bg-white shadow-sm rounded-2xl p-6 border border-gray-200 hover:shadow-lg transition">
      ...
      <div class="text-4xl font-bold text-green-600"><?php echo $totalHosts; ?></div>
    ...
    <div class="bg-white shadow-sm rounded-2xl p-6 border border-gray-200 hover:shadow-lg transition">
      ...
      <div class="text-4xl font-bold text-red-600"><?php echo $totalBanned; ?></div>
      ...
      <table class="min-w-full text-sm text-left">
        ...
        <tbody class="divide-y divide-gray-200">
          <?php foreach (array_slice($activities, 0, 6) as $activity): ?>
            <tr>
              <td class="px-4 py-2"><?php echo htmlspecialchars($activity['email']); ?></td>
              <td class="px-4 py-2"><?php echo $activity['role']; ?></td>
              <td class="px-4 py-2"><?php echo $activity['action']; ?></td>
              <td class="px-4 py-2"><?php echo $activity['date']; ?></td>
            </tr>
          <?php endforeach; ?>
        </tbody>
      </table>
